...
public class TypedResponseHandler implements Callback
{
    ...
    public TypedResponseHandler(Class responseClass, AppCompatActivity context, TypedResponseCallback callback, int actionCode)
    {
