...
public class RawContextTextResponseHandler implements Callback
{
    private Context context;
    private TextResponseCallback callback;
    private int actionCode;

    public RawContextTextResponseHandler(Context context, TextResponseCallback callback, int actionCode)
    {
