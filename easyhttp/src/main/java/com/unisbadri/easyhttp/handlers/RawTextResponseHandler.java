...
public class RawTextResponseHandler implements Callback
{
    private AppCompatActivity context;
    private TextResponseCallback callback;
    private int actionCode;

    public RawTextResponseHandler(AppCompatActivity context, TextResponseCallback callback, int actionCode)
    {
